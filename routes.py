...
def register_routes(app, config, db, backup_manager, gpg_backup):
    ...
    def customers():
        ...
        if search:
            customer_list = app.models.CustomerService.search_customers(search)
        else:
            active_only = (status != 'inactive')
            customer_list = app.models.CustomerService.get_all_customers(active_only=active_only)
    ...
    def create_backup_route():
        ...
        try:
            ...
            backup_record = app.models.BackupRecord(
    ...
    def list_backups():
        ...
        try:
            backup_records = app.models.BackupRecord.query.order_by(app.models.BackupRecord.created_at.desc()).all()
            backup_data = []
    ...
    def download_backup(backup_name):
        ...
        try:
            backup_record = app.models.BackupRecord.query.filter_by(filename=backup_name).first()
