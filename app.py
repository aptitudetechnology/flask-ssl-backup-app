"""
Flask Application with Pathlib Integration
Main application with SSL, database, and backup functionality
"""
...
def create_app(config_name=None):
    ...
    # Initialize database
    init_db(str(config.paths.database_file))
        ...
        try:
            ...
            for backup_path in backups:
                backup_info = {
                    ...
                    ).isoformat() if backup_path.exists() else None,
                    'type': 'encrypted' if backup_path.suffix == '.gpg' else 'regular'
                }
